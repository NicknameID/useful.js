...
// (function(){
  ...
  //   function Slider(aImgs,slider,step){
  ...
  // }
  // //添加
  // Slider.prototype.pre = function(jStyleNew,jStyleOld){
  ...
  //   }
  // };
  // Slider.prototype.next = function(jStyleNew,jStyleOld){
  //   if( !$(this.slider).is(':animated') ){
  //     this.now++;
  ...
  //   }
  // };
  // Slider.prototype.point = function(ev,jStyleNew,jStyleOld){
